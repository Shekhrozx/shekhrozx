...
- **Backend development:** Python and Go services, concurrent processing, distributed systems, and reusable packages
- **Languages:** Python, Go, JavaScript, TypeScript, and SQL
- **Frameworks:** Django and its ecosystem, Django REST Framework, Litestar, FastAPI, Flask, Gin, ReactJS, and PyPI package development
- **API and messaging:** RESTful APIs, TCP/IP, WebSockets, ORM, RabbitMQ, Celery, and Redis
- **Cloud and DevOps:** AWS, GCP, Docker, Kubernetes, GitHub/GitLab CI/CD, Nginx, and Gunicorn
- **Data:** PostgreSQL, PostGIS, MySQL/MariaDB, SQLite, MongoDB, and NoSQL systems
- **Engineering practice:** Linux, system design, automation, code review, refactoring, and technical leadership
- **ML/AI operations:** Model deployment, automation pipelines, and cloud integration
...
- Ph.D. in Civil and Environmental Engineering, Sejong University, South Korea
